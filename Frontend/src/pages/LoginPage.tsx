        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:w-2/5">
          <div className="w-full max-w-md animate-fade-in">
            ...
            <div className="lg:hidden mb-10 text-center">
              <h1 className="text-4xl font-bold text-primary mb-3">NyayaNet</h1>
            ...
            <div className="bg-card rounded-2xl shadow-2xl p-10 border border-border/50 backdrop-blur-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary text-white py-4 px-4 rounded-lg font-semibold transition-all duration-300 hover:bg-primary/90 hover:shadow-[0_10px_40px_-10px_rgba(59,130,246,0.5)] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background active:scale-[0.98] shadow-lg"
                >
                  Sign In
                </button>
