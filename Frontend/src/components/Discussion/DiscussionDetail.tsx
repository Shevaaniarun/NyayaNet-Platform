...
import { Send, Bookmark, Share2, Flag, CheckCircle, Gavel, Users, MessageSquare, Eye, Calendar, ChevronLeft, User, TrendingUp, Heart, Lock, ArrowBigUp, X, Plus } from 'lucide-react';
...
export function DiscussionDetail({
  ...
  return (
    <div className="min-h-screen bg-justice-black pb-8">
      {/* Premium Header */}
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-8">
            ...
            <div className="flex items-center gap-4 py-6 border-y border-constitution-gold/10">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-constitution-gold font-bold text-[10px] uppercase tracking-wider">
              ...
              <div className="flex items-center gap-4">
                {!discussion.isResolved && (
                  <button
                    ...
                    className="px-6 py-2.5 bg-constitution-gold text-justice-black rounded-full font-bold text-xs uppercase tracking-widest hover:bg-constitution-gold/90 transition-all shadow-lg flex items-center gap-2"
                  >
                    {showReplyForm ? <X className="w-4 h-4" /> : <Plus className="w-4 h-4" />}
                    {showReplyForm ? 'Cancel Reply' : 'Add Insight'}
                  </button>
                )}
        ...
        {/* Reply Form - Now hidden by default */}
        {showReplyForm && !discussion.isResolved && (
          <div className="aged-paper rounded-2xl p-6 md:p-8 mb-8 border-2 border-constitution-gold shadow-xl animate-in fade-in slide-in-from-bottom-4">
            <div className="flex items-center justify-between mb-6">
              ...
              >
                <X className="w-5 h-5 text-ink-gray/60" />
              </button>
            </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-end gap-4">
                  <button
                    type="button"
                    onClick={() => setShowReplyForm(false)}
                    className="px-6 py-2.5 text-ink-gray/60 hover:text-ink-gray border border-ink-gray/20 rounded-xl font-bold text-sm uppercase tracking-widest transition-colors"
                  >
                    Cancel
                  </button>
                  <button
            ...
            {discussion.replies.length > 0 ? (
              ...
              <div className="aged-paper rounded-2xl p-12 text-center border border-dashed border-constitution-gold/20">
                ...
                {!discussion.isResolved && (
                  <button
                    onClick={toggleReplyForm}
                    className="mt-4 px-6 py-2.5 bg-constitution-gold text-justice-black rounded-full font-bold text-sm uppercase tracking-widest hover:bg-constitution-gold/90 transition-all"
                  >
                    Add First Insight
                  </button>
                )}
